        ...
        html: `
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
                <div style="text-align: center; margin-bottom: 30px;">
                    <img src="https://lab-rador-assist.vercel.app/favicon.ico" alt="Your Logo" width="120" />
                </div>
                <h2 style="text-align: center; color: #2d3748;">Welcome to Lab-Rador Assist</h2>
                <p style="text-align: center;">You are invited to the laboratory: ${labId}</p>
                <p style="text-align: center;">for the role: ${role}</p>
